...
@Component({
  selector: 'app-customer-equipment-operations',
  templateUrl: './customer-equipment-operations.component.html',
  styleUrls: ['./customer-equipment-operations.component.scss']
})
export class CustomerEquipmentOperationsComponent implements OnInit {
  inputForm: FormGroup;
  ...
  constructor(private equipmentService: EquipmentService, private customerService: CustomerService,
              private dialogRef: MatDialogRef<CustomerEquipmentOperationsComponent>,
