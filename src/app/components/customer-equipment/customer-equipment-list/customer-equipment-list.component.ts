...
@Component({
  selector: 'app-customer-equipment-list',
  templateUrl: './customer-equipment-list.component.html',
  styleUrls: ['./customer-equipment-list.component.scss']
})
export class CustomerEquipmentListComponent implements OnInit {
